...
window.SectionTabs = function SectionTabs({ value, tabs, onChange }) {
  return (
...
window.EnvironmentBody = function EnvironmentBody({ data, set, onSwitchEnv }) {
...
window.BasicsBody = function BasicsBody({ data, set, slugCheck, onCheckSlug }) {
        ...
        <div className="form-grid cols-3">
          ...
          <div className="field">
            ...
            <div className="toggle-row" style={{ height: 40, padding: '8px 12px' }}>
              ...
              <window.Switch on={bulk.acceptTexts} onClick={() => setBulk({ acceptTexts: !bulk.acceptTexts })} />
            </div>
          </div>
          <div className="field span-full">
            <div className="toggle-row" style={{ padding: '10px 14px', borderRadius: 8, background: bulk.useFaker ? '#f0fdf4' : 'transparent', border: bulk.useFaker ? '1px solid #bbf7d0' : '1px solid transparent' }}>
              ...
              <window.Switch on={bulk.useFaker} onClick={() => setBulk({ useFaker: !bulk.useFaker })} />
            </div>
          </div>
          ...
          <div className="field" style={{ opacity: bulk.useFaker ? 0.35 : 1, pointerEvents: bulk.useFaker ? 'none' : 'auto' }}>
            ...
            <div className="toggle-row" style={{ height: 40, padding: '8px 12px' }}>
              ...
              <window.Switch on={bulk.addPhones} onClick={() => setBulk({ addPhones: !bulk.addPhones })} />
            </div>
          </div>
          <div className="field span-full">
            <div className="callout">
                  ...
                  <div className="form-grid cols-3">
                    ...
                    <div className="field">
                      ...
                      <div className="toggle-row" style={{ height: 40, padding: '8px 12px' }}>
                        ...
                        <window.Switch on={Boolean(record.accept_texts)} onClick={() => updateExactRecord(index, { accept_texts: !record.accept_texts })} />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {exactRecords.map((record, index) => (
                <div className="exact-record-card" key={`item-${index}`}>
                  ...
                  <div className="form-grid cols-3">
                    ...
                    <div className="field">
                      <label>Starting bid</label>
                      <input type="number" min="0" value={record.starting_bid ?? 0} onChange={e => updateExactRecord(index, { starting_bid: +e.target.value })} disabled={record.type === 'donation'} />
                    </div>
                    <div className="field">
                      <label>Bid increment</label>
...
window.AuctionSettingsBody = function AuctionSettingsBody({ data, bidders, set }) {
    ...
    <div className="section-pane-stack">
      <div className="field span-full">
        <div className="toggle-row" style={{ padding: '10px 14px', borderRadius: 8, background: settings.enabled ? '#eff6ff' : 'transparent', border: settings.enabled ? '1px solid #bfdbfe' : '1px solid transparent' }}>
          ...
          <window.Switch on={settings.enabled} onClick={() => setBool('enabled')} />
        </div>
      </div>
      ...
      <div className="form-grid cols-3" style={{ opacity: settings.enabled ? 1 : 0.45, pointerEvents: settings.enabled ? 'auto' : 'none' }}>
        ...
        <div className="field span-full">
          <div className="toggle-row" style={{ height: 40, padding: '8px 12px' }}>
            ...
            <window.Switch on={settings.useExistingMerchantAccount} onClick={() => setBool('useExistingMerchantAccount')} />
          </div>
        </div>
        <div className="field">
        ...
        <div className="field">
          ...
          <div className="toggle-row" style={{ height: 40, padding: '8px 12px' }}>
            ...
            <window.Switch on={settings.resetMobileCheckin} onClick={() => setBool('resetMobileCheckin')} />
          </div>
        </div>
        <div className="field">
        ...
        <div className="field span-full">
          <div className="toggle-row" style={{ height: 40, padding: '8px 12px' }}>
            ...
            <window.Switch on={settings.syncStartingBidderNumber} onClick={() => setBool('syncStartingBidderNumber')} />
          </div>
        </div>
      </div>
    </div>
...
window.TicketPagesBody = function TicketPagesBody({ data, items, set }) {
      ...
      {(record.customQuestions || []).map((question, questionIndex) => (
        <div className="exact-record-card" key={`${key}-${recordIndex}-question-${questionIndex}`} style={{ marginTop: 10 }}>
          ...
          <div className="form-grid cols-3">
            ...
            <div className="field"><label>Required</label><div className="toggle-row" style={{ height: 40, padding: '8px 12px' }}><div className="sub">Require answer</div><window.Switch on={Boolean(question.required)} onClick={() => updateRecordQuestion(key, recordIndex, questionIndex, { required: !question.required })} /></div></div>
            <div className="field"><label>Active</label><div className="toggle-row" style={{ height: 40, padding: '8px 12px' }}><div className="sub">Show this question</div><window.Switch on={question.isActive !== false} onClick={() => updateRecordQuestion(key, recordIndex, questionIndex, { isActive: question.isActive === false })} /></div></div>
    ...
    <div className="section-pane-stack">
      <div className="field span-full">
        <div className="toggle-row" style={{ padding: '10px 14px', borderRadius: 8, background: ticketPages.enabled ? '#eff6ff' : 'transparent', border: ticketPages.enabled ? '1px solid #bfdbfe' : '1px solid transparent' }}>
          ...
          <window.Switch on={ticketPages.enabled} onClick={() => setPreset(ticketPages.enabled ? 'off' : (ticketPages.preset === 'off' ? 'basic' : ticketPages.preset))} />
        </div>
      </div>
        ...
        {[
          ...
          <div className="field" key={key}>
            ...
            <div className="toggle-row" style={{ height: 40, padding: '8px 12px' }}>
              ...
              <window.Switch on={Boolean(page.settings[key])} onClick={() => commitSettings({ [key]: !page.settings[key] })} />
            </div>
          </div>
        ))}
        ...
        {page.individualTickets.map((record, index) => (
          <div className="exact-record-card span-full" key={`ticket-${index}`}>
            ...
            <div className="form-grid cols-3">
              ...
              <div className="field"><label>Visible</label><div className="toggle-row" style={{ height: 40, padding: '8px 12px' }}><div className="sub">Show online</div><window.Switch on={record.visible !== false} onClick={() => updateRecord('individualTickets', index, { visible: !record.visible })} /></div></div>
        ...
        {page.sponsors.map((record, index) => (
          <div className="exact-record-card span-full" key={`sponsor-${index}`}>
            ...
            <div className="form-grid cols-3">
              ...
              <div className="field"><label>Visible</label><div className="toggle-row" style={{ height: 40, padding: '8px 12px' }}><div className="sub">Show online</div><window.Switch on={record.visible !== false} onClick={() => updateRecord('sponsors', index, { visible: !record.visible })} /></div></div>
        ...
        {page.selections.map((record, index) => (
          <div className="exact-record-card span-full" key={`selection-${index}`}>
            ...
            <div className="form-grid cols-3">
              ...
              <div className="field"><label>Visible</label><div className="toggle-row" style={{ height: 40, padding: '8px 12px' }}><div className="sub">Show online</div><window.Switch on={record.visible !== false} onClick={() => updateRecord('selections', index, { visible: !record.visible })} /></div></div>
            </div>
          </div>
        ))}
...
window.PostCreateActivityBody = function PostCreateActivityBody({ data, ticketPages, set }) {
    ...
    <div className="section-pane-stack">
      <div className="field span-full">
        <div className="toggle-row" style={{ padding: '10px 14px', borderRadius: 8, background: activity.enabled ? '#eff6ff' : 'transparent', border: activity.enabled ? '1px solid #bfdbfe' : '1px solid transparent' }}>
          ...
          <window.Switch on={activity.enabled} onClick={() => commit({ enabled: !activity.enabled })} />
        </div>
      </div>
      ...
      <div className="form-grid cols-3" style={{ opacity: activityDisabled ? 0.45 : 1, pointerEvents: activityDisabled ? 'none' : 'auto' }}>
        ...
        <div className="field">
          ...
          <div className="toggle-row" style={{ height: 40, padding: '8px 12px' }}>
            ...
            <window.Switch on={purchase.enabled !== false} onClick={() => commitPurchase({ enabled: purchase.enabled === false })} />
          </div>
        </div>
        <div className="field">
          ...
          <div className="toggle-row" style={{ height: 40, padding: '8px 12px' }}>
            ...
            <window.Switch on={activity.useFaker !== false} onClick={() => commit({ useFaker: activity.useFaker === false })} />
          </div>
        </div>
      ...
      <div className="form-grid cols-3" style={{ opacity: ticketDisabled ? 0.45 : 1, pointerEvents: ticketDisabled ? 'none' : 'auto' }}>
        ...
        <div className="field">
          <label>Donation purchases</label>
          <input
            type="number"
            min="0"
            max={purchase.paymentMix?.credit_card ?? 0}
            value={purchase.donationPurchaseCount ?? 0}
            onChange={e => commitPurchase({ donationPurchaseCount: Math.max(0, Number(e.target.value) || 0) })}
          />
          <div className="help">How many credit-card purchases also add a donation (max = credit-card count). 0 = none.</div>
        </div>
        <div className="field">
          <label>Donation amount</label>
          <input type="number" min="1" value={purchase.donationAmount} disabled={(purchase.donationPurchaseCount ?? 0) === 0} onChange={e => commitPurchase({ donationAmount: +e.target.value })} />
          <div className="help">Applied to each donating purchase. Donations require credit-card purchases.</div>
        </div>
        <div className="field span-full">
          <div className="callout">
      ...
      <div className="form-grid cols-3" style={{ opacity: activityDisabled ? 0.45 : 1, pointerEvents: activityDisabled ? 'none' : 'auto' }}>
        ...
        <div className="field">
          ...
          <div className="toggle-row" style={{ height: 40, padding: '8px 12px' }}>
            ...
            <window.Switch on={auction.enabled} onClick={() => commitAuction({ enabled: !auction.enabled })} />
          </div>
        </div>
        <div className="field">
        ...
        <div className="field">
          ...
          <div className="toggle-row" style={{ height: 40, padding: '8px 12px' }}>
            ...
            <window.Switch on={auction.includeSilent !== false} onClick={() => commitAuction({ includeSilent: auction.includeSilent === false })} />
          </div>
        </div>
        <div className="field">
          ...
          <div className="toggle-row" style={{ height: 40, padding: '8px 12px' }}>
            ...
            <window.Switch on={auction.includeLive !== false} onClick={() => commitAuction({ includeLive: auction.includeLive === false })} />
          </div>
        </div>
      </div>
      ...
      <div className="form-grid cols-3" style={{ opacity: activityDisabled ? 0.45 : 1, pointerEvents: activityDisabled ? 'none' : 'auto' }}>
        ...
        <div className="field">
          ...
          <div className="toggle-row" style={{ height: 40, padding: '8px 12px' }}>
            ...
            <window.Switch on={donations.enabled} onClick={() => commitDonations({ enabled: !donations.enabled })} />
          </div>
        </div>
        <div className="field">
...
window.SettingsBody = function SettingsBody({ data, set, onTestConnection, testState, testError, onSaveProfile, onLoadProfile, onDeleteProfile }) {
